...
class AllnimallImagePicker extends StatefulWidget {
  ...
  @override
  State<AllnimallImagePicker> createState() => _AllnimallImagePickerState();
}

class _AllnimallImagePickerState extends State<AllnimallImagePicker> {
  File? _selectedImage;
